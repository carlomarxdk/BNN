...
class Model(object):
    ...
    def __init__(self, n_classes, n_features, n_hidden_units=10, learning_rate=0.01, epochs = 10, decay = 0.7 ):
    ...
    def _init_weights(self):
        ...
        w2 = tf.Variable(tf.random.uniform(shape=(self.n_hidden_units*5, self.n_hidden_units), minval=-1.0, maxval=1.0))
        w3 = tf.Variable(tf.random.uniform(shape=(self.n_hidden_units*10, self.n_hidden_units*5), minval=-1.0, maxval=1.0))
        w4 = tf.Variable(tf.random.uniform(shape=(1, self.n_hidden_units*10), minval=-1.0, maxval=1.0))
