...
class Model(tf.keras.Model):
    def __init__(self,
        ...
        self.l_1 = BinaryConv2D(filters=48, kernel_size=(3, 3), padding='valid')
        self.pool_1 = tf.keras.layers.MaxPooling2D(pool_size=(2, 2))
        self.l_2 = BinaryConv2D(filters=96, kernel_size=(3,3), padding='valid')
        self.pool_2 = tf.keras.layers.MaxPooling2D(pool_size=(2, 2))

        self.l_3 = BinaryConv2D(filters=192, kernel_size=(3,3), padding='valid')
